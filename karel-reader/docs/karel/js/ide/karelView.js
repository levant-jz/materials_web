...
KarelView.getImage = function(karelModel) {
    switch (karelModel.getDirection()) {
        case Const.KAREL_NORTH:
            return karelImages.karelNorth;
        case Const.KAREL_SOUTH:
            return karelImages.karelSouth;
        case Const.KAREL_EAST:
            return karelImages.karelEast;
        case Const.KAREL_WEST:
            return karelImages.karelWest;
    }
    return null;
}
...
KarelView.getTinyImage = function(karelModel) {
    switch (karelModel.getDirection()) {
        case Const.KAREL_NORTH:
            return karelImages.karelNorthTiny;
        case Const.KAREL_SOUTH:
            return karelImages.karelSouthTiny;
        case Const.KAREL_EAST:
            return karelImages.karelEastTiny;
        case Const.KAREL_WEST:
            return karelImages.karelWestTiny;
    }
    return null;
}
...
KarelView.getSmallImage = function(karelModel) {
    switch (karelModel.getDirection()) {
        case Const.KAREL_NORTH:
            return karelImages.karelNorthSmall;
        case Const.KAREL_SOUTH:
            return karelImages.karelSouthSmall;
        case Const.KAREL_EAST:
            return karelImages.karelEastSmall;
        case Const.KAREL_WEST:
            return karelImages.karelWestSmall;
    }
    return null;
}
