! function(e, t) {
    ...
    var t = "SweetAlert2:",
        ...
        L = function() {
            return !T() && !document.body.classList.contains(_["no-backdrop"])
        },
        T = function() {
        ...
        X = function(e) {
            ...
            if (t && (t.parentNode.removeChild(t), W([document.documentElement, document.body], [_["no-backdrop"], _["toast-shown"], _["has-column"]])), !j()) {
                ...
                var f = function(e) {
                    Re.isVisible() && o !== e.target.value && Re.resetValidationMessage(), o = e.target.value
                };
        ...
        ue = function(e, n) {
            ...
            if (t) {
                ...
                var i = function() {
                    var e, t;
                    T() || (e = window.scrollX, t = window.scrollY, ce.restoreFocusTimeout = setTimeout(function() {
                        ce.previousActiveElement && ce.previousActiveElement.focus ? (ce.previousActiveElement.focus(), ce.previousActiveElement = null) : document.body && document.body.focus()
                    }, 100), void 0 !== e && void 0 !== t && window.scrollTo(e, t), ce.keydownTarget.removeEventListener("keydown", ce.keydownHandler, {
                        capture: ce.keydownListenerCapture
                    }), ce.keydownHandlerAdded = !1), o.parentNode && o.parentNode.removeChild(o), W([document.documentElement, document.body], [_.shown, _["height-auto"], _["no-backdrop"], _["toast-shown"], _["toast-column"]]), L() && (null !== b.previousBodyPadding && (document.body.style.paddingRight = b.previousBodyPadding, b.previousBodyPadding = null), function() {
                ...
                ee && !v(t, _.noanimation) ? t.addEventListener(ee, function e() {
                    t.removeEventListener(ee, e), v(t, _.hide) && i()
                }) : i()
            }
        };
    ...
    var de = {
        ...
        ge = function(e) {
            for (var t in e) me(t) || q('Unknown parameter "'.concat(t, '"')), e.toast && -1 !== fe.indexOf(t) && q('The parameter "'.concat(t, '" is incompatible with toasts')), he(t) && m('The parameter "'.concat(t, '" is deprecated and will be removed in the next major release.'))
        },
        ...
        Ce = Object.freeze({
            ...
            queue: function(e) {
                ...
                return new Promise(function(i) {
                    ! function t(n, o) {
                        n < ye.length ? (document.body.setAttribute("data-swal2-queue-step", n), r(ye[n]).then(function(e) {
    ...
    var Le = function(e) {
        var t = w(),
            n = k();
        null !== e.onBeforeOpen && "function" == typeof e.onBeforeOpen && e.onBeforeOpen(n), e.animation ? (N(n, _.show), N(t, _.fade), W(n, _.hide)) : W(n, _.fade), U(n), t.style.overflowY = "hidden", ee && !v(n, _.noanimation) ? n.addEventListener(ee, function e() {
            n.removeEventListener(ee, e), t.style.overflowY = "auto"
        }) : t.style.overflowY = "auto", N([document.documentElement, document.body, t], _.shown), e.heightAuto && e.backdrop && !e.toast && N([document.documentElement, document.body], _["height-auto"]), L() && (se(), function() {
        ...
        })), T() || ce.previousActiveElement || (ce.previousActiveElement = document.activeElement), null !== e.onOpen && "function" == typeof e.onOpen && setTimeout(function() {
            e.onOpen(n)
        })
    };
    var Te, je = Object.freeze({
        ...
        resetValidationError: function() {
            m("Swal.resetValidationError() is deprecated and will be removed in the next major release, use Swal.resetValidationMessage() instead"), Pe.bind(this)()
        },
        showValidationError: function(e) {
            m("Swal.showValidationError() is deprecated and will be removed in the next major release, use Swal.showValidationMessage() instead"), Se.bind(this)(e)
        },
        ...
        _main: function(e) {
            ...
            ! function(t) {
                var e;
                t.inputValidator || Object.keys(Ee).forEach(function(e) {
                    t.input === e && (t.inputValidator = t.expectRejections ? Ee[e] : Re.adaptInputValidator(Ee[e]))
                }), t.validationMessage && ("object" !== V(t.extraParams) && (t.extraParams = {}), t.extraParams.validationMessage = t.validationMessage), (!t.target || "string" == typeof t.target && !document.querySelector(t.target) || "string" != typeof t.target && !t.target.appendChild) && (q('Target parameter is not valid, defaulting to "body"'), t.target = "body");
                var n = k(),
            ...
            return new Promise(function(t, n) {
                var o = function(e) {
                        M.closePopup(T.onClose, T.onAfterClose), T.useRejections ? t(e) : t({
                            value: e
                        })
                    },
                    c = function(e) {
                        M.closePopup(T.onClose, T.onAfterClose), T.useRejections ? n(e) : t({
                            dismiss: e
                        })
                    },
                    u = function(e) {
                        M.closePopup(T.onClose, T.onAfterClose), n(e)
                    };
                T.timer && (ce.timeout = new Oe(function() {
                    c("timer"), delete ce.timeout
                ...
                for (var l = function(t) {
                        if (T.showLoaderOnConfirm && M.showLoading(), T.preConfirm) {
                            ...
                            T.expectRejections ? e.then(function(e) {
                                ...
                                F(j.validationMessage) || !1 === e ? L.hideLoading() : o(e || t)
                            }, function(e) {
                                return u(e)
                            })
                        } else o(t)
                ...
                if (j.closeButton.onclick = function() {
                        c(M.DismissReason.close)
                    }, T.toast) j.popup.onclick = function() {
                    T.showConfirmButton || T.showCancelButton || T.showCloseButton || T.input || c(M.DismissReason.close)
                };
                else {
                    var a = !1;
                    j.popup.onmousedown = function() {
                        ...
                        a ? a = !1 : e.target === j.container && H(T.allowOutsideClick) && c(M.DismissReason.backdrop)
                    }
                }
                ...
                ce.keydownHandlerAdded && (ce.keydownTarget.removeEventListener("keydown", ce.keydownHandler, {
                    capture: ce.keydownListenerCapture
                }), ce.keydownHandlerAdded = !1), T.toast || (ce.keydownHandler = function(e) {
                    return function(e, t) {
                ...
                }, ce.keydownTarget = T.keydownListenerCapture ? window : j.popup, ce.keydownListenerCapture = T.keydownListenerCapture, ce.keydownTarget.addEventListener("keydown", ce.keydownHandler, {
                    capture: ce.keydownListenerCapture
                }), ce.keydownHandlerAdded = !0), L.enableButtons(), L.hideLoading(), L.resetValidationMessage(), T.toast && (T.input || T.footer || T.showCloseButton) ? N(document.body, _["toast-column"]) : W(document.body, _["toast-column"]);
                ...
                if ("select" === T.input || "radio" === T.input) {
                    ...
                    I(T.inputOptions) ? (M.showLoading(), T.inputOptions.then(function(e) {
                        L.hideLoading(), E(e)
                ...
                } else -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(T.input) && I(T.inputValue) && (M.showLoading(), K(d), T.inputValue.then(function(e) {
    ...
    }, r(Me.prototype, je), r(Me, Ce), Object.keys(je).forEach(function(t) {
        Me[t] = function() {
            var e;
            if (Te) return (e = Te)[t].apply(e, arguments)
        }
    }), Me.DismissReason = e, Me.noop = function() {}, Me.version = "7.28.1";
    var Ve, qe, Re = le((Ve = Me, qe = function(e) {
        ...
        return a(t, Ve), i(t, [{
            key: "_main",
            value: function(e) {
                return p(c(t.prototype), "_main", this).call(this, r({}, ve, e))
            }
        }], [{
            key: "setDefaults",
            value: function(t) {
                if (m(be), !t || "object" !== V(t)) throw new TypeError("SweetAlert2: The argument for setDefaults() is required and has to be a object");
                ge(t), Object.keys(t).forEach(function(e) {
                    Ve.isValidParameter(e) && (ve[e] = t[e])
                })
            }
        }, {
            key: "resetDefaults",
